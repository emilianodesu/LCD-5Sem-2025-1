...
# Ejecute en Linux o MAC: mpirun -n 2 python3 MPI07.py
# Ejecute en Windows: mpiexec -n 2 python3 MPI07.py
...
if rank == 0:
        ...
        # Comentar 'req.Wait' y volver a correr para observar el comportamiento del destino no bloqueante.
        req.Wait()
