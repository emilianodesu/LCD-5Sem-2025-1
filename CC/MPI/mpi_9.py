...
# Ejecute en Linux o MAC: mpirun -n 2 python3 MPI09.py
# Ejecute en Windows: mpiexec -n 2 python3 MPI09.py
...
if rank == 1:
        ...
        # Imprime la división.
        print("Si esperar, el proceso 1 realiza la division:  diffNum = ", diffNum[0])
