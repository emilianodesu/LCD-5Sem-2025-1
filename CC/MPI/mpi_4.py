...
# Ejecute en Linux o MAC: mpirun -n 2 python3 MPI04.py
# Ejecute en Windows: mpiexec -n 2 python3 MPI04.py
...
if rank == 1:
        ...
        # Espera unos segundos antes de enciar el mensaje.
        time.sleep(5)
...
if rank == 0:
        ...
        # La función 'comm.Recv' puede recibir el dato con el mismo nombre (randNum) de la variable del emisor.
        comm.Recv(NAleatorio, source=1)

        # Imprime el mensaje.
        print("Proceso", rank, "recibió el número", NAleatorio[0])
